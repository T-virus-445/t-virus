...
|__  $$__/     | $$   | $$|_  $$_/| $$__  $$| $$  | $$ /$$__  $$ /$$__  $$
 ...
 \033[1;32m+ -- -- +=[ Autor: Mateus Veras | Facebook: Chernobyl hackers OBIRGADO> Luuuh MEU MOR LUANA Obrigado >> Guilherme,LEooo Obrigado \033[1;m
...
5) Help
			...
			''')
				...
				opcion0 = raw_input("\033[1;36mT-virus > \033[1;m")
			
				while opcion0 == "1":
					print ('''
1) Add T-virus  Repositorio
2) Update
3) Remova o Repositorio T-virus 
4) Ver se  o Repositorio esta no /etc/apt/sources.list
...
0) Install all Information Gathering tools
						...
						''')
							print ("\033[1;32mcoloque um numero para poder instalar a ferramenta .\n\033[1;m")
							...
							if opcion2 == "1":
								...
								cmd = os.system("apt-get install -y acccheck ace-voip amap automater braa casefile cdpsnarf cisco-torch  copy-router-config dmitry dnmap dnsenum dnsmap dnsrecon dnstracer dnswalk   enumiax exploitdb fierce  fragroute fragrouter  golismero goofile  maltego masscan metagoofil miranda nmap p0f recon-ng set smtp-user-enum snmpcheck sslcaudit sslsplit sslstrip sslyze thc-ipv6 theharvester tlssled twofi urlcrazy wireshark wol-e xplico intrace hping3 && wget http://www.morningstarsecurity.com/downloads/bing-ip2hosts-0.4.tar.gz && tar -xzvf bing-ip2hosts-0.4.tar.gz && cp bing-ip2hosts-0.4/bing-ip2hosts /usr/local/bin/")				
							else:
								print ("\033[1;31mSorry, that was an invalid command!\033[1;m")
...
0) Install all Vulnerability Analysis tools
						...
						''')
							print ("\033[1;32coloque um numero para poder instalar a ferramenta .\n\033[1;m")
							opcion2 = raw_input("\033[1;36mkat > \033[1;m")
							if opcion2 == "1":
...
0) Install all Wireless Attacks tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("wget http://ubuntu.mirrors.tds.net/ubuntu/pool/universe/p/python-support/python-support_1.0.14ubuntu2_all.deb && dpkg -i python-support_1.0.14ubuntu2_all.deb  && apt-get install fern-wifi-cracker")
							elif opcion2 == "13":
								cmd = os.system("apt-get install git && git clone https://github.com/wi-fi-analyzer/ghost-phisher.git")
							elif opcion2 == "14":
...
0) Install all Web Applications tools
						...
						''')
							...
							if opcion2 == "1":
								...
								cmd = os.system("sudo add-apt-repository ppa:openjdk-r/ppa && apt-get update && apt-get install openjdk-7-jdk -y &&   apt-get install vega")
							elif opcion2 == "33":
